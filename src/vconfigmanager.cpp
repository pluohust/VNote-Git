...
void VConfigManager::initialize()
{
    ...
    // git
    gitName = getConfigFromSettings("global", "git_name").toString();
    gitPassword = getConfigFromSettings("global", "git_password").toString();
    gitEmail = getConfigFromSettings("global", "git_email").toString();
}
