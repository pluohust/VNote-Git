...
void VFileList::newDiaryNote()
{
    ...
    QString todayWith = today + ".%1";
    QString defaultName = todayWith.arg(defaultSuf);
    defaultName = VUtils::getFileNameWithSequence(m_directory->fetchPath(), defaultName, true);
